...
export const CITY_PLACES: CityPlaces[] = [
  ...
  },
  {
    city: "Lucknow",
    places: [
      { id: "l1", name: "Bara Imambara", rating: 4.8, description: "Massive 18th-century Mughal complex with the famous Bhool Bhulaiya maze", category: "historical" },
      { id: "l2", name: "Chota Imambara", rating: 4.6, description: "Ornate golden palace of lights with elaborate chandeliers and calligraphy", category: "historical" },
      { id: "l3", name: "Rumi Darwaza", rating: 4.7, description: "Iconic 60-ft gateway built in Awadhi style, symbol of Lucknow", category: "historical" },
      { id: "l4", name: "British Residency", rating: 4.5, description: "Ruins of the 1857 revolt siege — a key historical landmark", category: "historical" },
      { id: "l5", name: "Hazratganj Market", rating: 4.4, description: "Lucknow's iconic high street for shopping, food, and culture", category: "market" },
      { id: "l6", name: "Aminabad Market", rating: 4.2, description: "Old Lucknow bazaar famous for chikan embroidery and street food", category: "market" },
      { id: "l7", name: "Lucknow Zoo", rating: 4.3, description: "One of India's oldest zoos with a toy train and botanical garden", category: "nature" },
      { id: "l8", name: "Ambedkar Memorial Park", rating: 4.4, description: "Grand sandstone park with stunning architecture, beautiful at night", category: "cultural" },
      { id: "l9", name: "Janeshwar Mishra Park", rating: 4.5, description: "Asia's largest planned park — great for morning walks and boating", category: "nature" },
      { id: "l10", name: "Tunday Kababi", rating: 4.7, description: "Legendary 100-year-old shop famous for melt-in-mouth galouti kebabs", category: "food" },
      { id: "l11", name: "Prakash Kulfi", rating: 4.5, description: "Iconic kulfi shop in Aminabad serving rich malai kulfi since decades", category: "food" },
      { id: "l12", name: "Chattar Manzil", rating: 4.3, description: "Umbrella Palace — a striking Nawabi-era riverside palace", category: "historical" },
      { id: "l13", name: "Dilkusha Kothi", rating: 4.1, description: "Ruined English country house used as a hunting lodge by Nawabs", category: "historical" },
      { id: "l14", name: "La Martiniere College", rating: 4.6, description: "Stunning Indo-European colonial school, architectural masterpiece", category: "cultural" },
      { id: "l15", name: "Picture Gallery (Husainabad)", rating: 4.2, description: "Gallery with portraits of Awadh Nawabs in a beautiful clock tower complex", category: "cultural" },
      { id: "l16", name: "Kukrail Forest Reserve", rating: 4.0, description: "Green escape with crocodile rehabilitation centre on city outskirts", category: "nature" },
      { id: "l17", name: "Nawabi Food Walk (Chowk)", rating: 4.6, description: "Walk through old Chowk lanes tasting kebabs, biryani, and nihari", category: "food" },
      { id: "l18", name: "Constantia House", rating: 4.3, description: "Original La Martiniere building, finest 18th-century architecture", category: "cultural" },
      { id: "l19", name: "Gomti Riverfront", rating: 4.1, description: "Scenic waterfront promenade with gardens and evening lights", category: "nature" },
      { id: "l20", name: "Chikan Embroidery Workshop", rating: 4.4, description: "Watch artisans create Lucknow's world-famous chikankari embroidery", category: "cultural" },
    ],
  },
  {
    city: "Prayagraj",
    places: [
      { id: "p1", name: "Triveni Sangam", rating: 4.9, description: "Sacred confluence of Ganga, Yamuna, and mythical Saraswati rivers", category: "religious" },
      { id: "p2", name: "Allahabad Fort", rating: 4.5, description: "Mughal-era fort by Akbar at the Sangam with Ashoka Pillar inside", category: "historical" },
      { id: "p3", name: "Anand Bhawan", rating: 4.6, description: "Nehru family ancestral home turned museum — fascinating political history", category: "historical" },
      { id: "p4", name: "Khusro Bagh", rating: 4.4, description: "Walled Mughal garden with three stunning sandstone tombs", category: "historical" },
      { id: "p5", name: "Allahabad Museum", rating: 4.3, description: "Terracotta art, Rajasthani miniatures, and freedom struggle exhibits", category: "cultural" },
      { id: "p6", name: "Chandrasekhar Azad Park", rating: 4.5, description: "Historic park where freedom fighter Azad made his last stand", category: "historical" },
      { id: "p7", name: "Swaraj Bhawan", rating: 4.4, description: "Birthplace of Indira Gandhi, now a museum of the independence movement", category: "historical" },
      { id: "p8", name: "All Saints Cathedral", rating: 4.3, description: "Gothic-style Anglican cathedral with beautiful stained glass windows", category: "cultural" },
      { id: "p9", name: "Muir Central College", rating: 4.5, description: "Stunning Indo-Gothic architecture — one of the most beautiful campuses", category: "cultural" },
      { id: "p10", name: "Hanuman Mandir (Sangam)", rating: 4.6, description: "Unique temple with a reclining Hanuman idol, near Sangam", category: "religious" },
      { id: "p11", name: "Mankameshwar Temple", rating: 4.3, description: "Ancient Shiva temple on the banks of Saraswati, spiritual atmosphere", category: "religious" },
      { id: "p12", name: "Boat Ride at Sangam", rating: 4.7, description: "Ride to the exact confluence point — see the rivers merge", category: "cultural" },
      { id: "p13", name: "Shringverpur", rating: 4.2, description: "Ancient site 35 km away where Lord Ram crossed the Ganga", category: "religious" },
      { id: "p14", name: "Civil Lines Heritage Walk", rating: 4.1, description: "Walk through colonial-era bungalows, churches, and institutions", category: "cultural" },
      { id: "p15", name: "Patalpuri Temple (Fort)", rating: 4.3, description: "Underground temple inside Allahabad Fort with ancient banyan tree", category: "religious" },
      { id: "p16", name: "Netaji Subhash Chandra Bose Museum", rating: 4.0, description: "Museum dedicated to Netaji in a heritage colonial building", category: "cultural" },
      { id: "p17", name: "Kachori Gali", rating: 4.5, description: "Famous street for Prayagraj's legendary kachori, jalebi, and chaat", category: "food" },
      { id: "p18", name: "Alopi Devi Mandir", rating: 4.2, description: "Unique Shakti Peeth where a wooden cradle is worshipped instead of an idol", category: "religious" },
      { id: "p19", name: "Magh Mela Grounds", rating: 4.4, description: "Site of the annual Magh Mela and Kumbh Mela — spiritual and vast", category: "religious" },
      { id: "p20", name: "Saraswati Ghat", rating: 4.1, description: "Peaceful ghat for evening walks and views of the river confluence", category: "nature" },
    ],
  },
];
